...
**ARIELLE alignment:** Explicit Hierarchy (E), Safety Boundaries (S)
...
**ARIELLE alignment:** Reduced Scope (R), Orchestrated Composition (O)
...
**ARIELLE alignment:** Safety Boundaries (S)
...
**ARIELLE alignment:** Progressive Disclosure (P), Orchestrated Composition (O)
...
**ARIELLE alignment:** Progressive Disclosure (P)
...
**ARIELLE alignment:** Progressive Disclosure (P), context must be explicit (Grounding Principle #2)
